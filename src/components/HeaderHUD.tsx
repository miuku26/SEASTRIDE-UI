...
export const HeaderHUD: React.FC<HeaderHUDProps> = ({
  ...
  return (
    <header
      className="sticky top-0 z-40 bg-[#2b1d19] border-b-4 sm:border-b-8 border-[#4a2c17] shadow-2xl text-amber-100 select-none"
      ...
      <div className="px-2 sm:px-3 py-1.5 flex items-center justify-center sm:justify-between gap-1.5 max-w-4xl mx-auto flex-wrap">
        ...
        <div className="flex items-center bg-[#4a2c17] border-4 border-[#2b1d19] rounded-xl shadow-[0_4px_0_#2b1d19] px-2 sm:px-3 py-0.5 sm:py-1 shadow-md tutorial-energy-bar">
          ...
          <div className="flex flex-col">
            <div className="flex items-center justify-between text-[9px] sm:text-[10px] text-[#f0dec1] font-black uppercase tracking-wider">
              <span>Energy</span>
              <span className="ml-1.5 text-white font-black">
                {energy}/{maxEnergy}
              </span>
            </div>
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            className="flex items-center gap-1 bg-[#34aab2] border-b-4 border-[#1e7880] text-white rounded-xl px-2 py-0.5 sm:px-2.5 sm:py-1 text-[10px] sm:text-xs font-bold active:scale-95 transition-transform"
          >
          ...
          <button
            onClick={onHelp}
            className="p-1 sm:p-1.5 bg-[#8b5a33] border-b-4 border-[#4a2c17] text-white rounded-xl active:scale-90"
            title="Help & Tutorial"
          >
          ...
          <button
            onClick={toggleMute}
            className="p-1 sm:p-1.5 bg-[#d75448] border-b-4 border-[#9b3026] text-white rounded-xl active:scale-90"
