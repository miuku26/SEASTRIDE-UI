            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 max-h-[40vh] overflow-y-auto pr-1">
                {ownedCannons.map((cannon, index) => {
                  ...
                  return (
                    <div key={cannon.id} className="bg-[#2b1d19] border-2 border-[#b45309] rounded-xl p-2 flex items-center gap-3">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 max-h-[40vh] overflow-y-auto pr-1">
                ...
                {ownedShields.map((shield, index) => {
                  ...
                  return (
                    <div key={shield.id} className="bg-[#2b1d19] border-2 border-[#b45309] rounded-xl p-2 flex items-center gap-3">
                      <div className="bg-[#4a2c17] rounded-lg p-1 border border-[#b45309] flex-shrink-0 relative">
                        <ItemImg
